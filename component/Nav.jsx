    ...
    <nav className={styles.nav}>
      <div className={styles.navbar}>
        ...
        <div className={styles.nav_logo}>
          <Link href="/">
            <a>
              <Image src="/img/kinox RED.png" width={50} height={70} />
            </a>
          </Link>
        </div>
        ...
        <div className={styles.nav_icons}>
          <AiOutlineSearch  className={styles.nav_icon} size={30} />
          <AiOutlineShoppingCart className={styles.nav_icon} size={30} />
          <GiHamburgerMenu className={styles.nav_icon_menu} size={30} onClick={handleNav} />
